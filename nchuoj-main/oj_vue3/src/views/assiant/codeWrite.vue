...
<div class="des">
    <div class="title">我可以为您进行代码分析</div>
</div>
<div class="change">

    <div class="itemBox">
        <div class="title">请输入您的代码</div>
    ...
    <div class="itemBox">
        <div class="title">这是分析后的代码</div>
        <textarea name="" class="inputBox" id="" cols="60" rows="40"></textarea>
    </div>
</div>
</div>
</div>
...
let handleSearch = () => {
    ...
    let textcontent = "请为以下代码添加注释，解释每个代码块是干什么用的"+text;
    axios({
        method: "post",
        url: `/talk`,
        headers: {
